...
### DkZ Ecosystem Analyzer -- Module pruefen, debuggen, dokumentieren, strukturieren und bewerten
...
![Lines](https://img.shields.io/badge/Lines-1542-ffb800?style=for-the-badge)
...
```mermaid
graph TB
    A[Ecosystem Analyzer] --> B[index.html]
    A --> C[style.css]
    A --> D[script.js]
...
```bash
# Clone
git clone https://github.com/7IKED/dkz-ecosystem-analyzer.git

# Oeffnen
cd dkz-ecosystem-analyzer
